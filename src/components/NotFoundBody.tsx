 ...
 * same page — a visitor should not get a different, worse version depending
 * on how many slashes they typed.
 */
  ...
  return (
    <section className="wrap" style={{ padding: "64px 24px 0" }}>
      ...
      <p style={{ color: "var(--muted)", fontSize: ".88rem", marginTop: 40 }}>
        ...
        <code>semanticauthoring.org/first-last</code> —{" "}
